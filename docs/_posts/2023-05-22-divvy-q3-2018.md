...
in the README file located here.

<h2>Overview</h2>
<p> The interactive map below highlights all trips taken via Divvy in Q3
of 2018 (weirdly, just July - September). Each shaded blue area corresponds to one of the
...
<br>
I created the "normalized" trip count measure to try to account for the fact that stations displaying high trip counts
might just be stocked with more bikes available to take trips on. To create the measure, I divide a station's total trip count by
the number of total bike docks available. This yields a measure in standardized units
of trips per station bike.
</p>
...
on its journey during the week of July 1 to July 8, 2018. I selected bike 3205 because it starts July 1 by being parked at
the Ellis & 55th Divvy station, my local station when I used Divvy to commute to class during my first year of graduate school. As the visualization shows, the bike putzes around Hyde Park for only a short time before being ridden to the North Side, where it remains for the rest of the sample period.
</p>
